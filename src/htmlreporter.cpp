...
void HtmlReporter::printSummary(ofstream& ofs, FilterResult* result, Stats* preStats1, Stats* postStats1, Stats* preStats2, Stats* postStats2) {
    ...
    ofs << endl;
    ofs << "<h1 style='text-align:left;'><a href='https://github.com/SongDabao/Fastp2' target='_blank' style='color:#663355;text-decoration:none;'>" + mOptions->reportTitle + "</a>"<<endl;
    ...
    outputRow(ofs, "Fastp2 version:", string(RABBITQC_VER)+ " (<a href='https://github.com/SongDabao/Fastp2'>https://github.com/SongDabao/Fastp2</a>)");
...
void HtmlReporter::printHeader(ofstream& ofs){
    ...
    //ofs << "<title>Fastp2 report at " + getCurrentSystemTime() + " </title>";
    ofs << "<title>Fastp2 report at " + getCurrentSystemTime() + " </title>";
    printJS(ofs);
    printCSS(ofs);
    ofs << "</head>";
...
void HtmlReporter::printFooter(ofstream& ofs){
    ...
    ofs << "<div id='footer'> ";
    ofs << "<p>"<<command<<"</p>";
    ofs << "Fastp2 " << RABBITQC_VER << ", at " << getCurrentSystemTime() << " </div>";
    ofs << "</body></html>";
}
