...
int main(int argc, char* argv[]){
    ...
    if(argc == 1) {
        cerr << "fastp2: an ultra-fast all-in-one FASTQ preprocessor" << endl << "version " << RABBITQC_VER << endl;
    ...
    cmd.add<int>("umi_skip", 0, "if the UMI is in read1/read2, fastp2 can skip several bases following UMI, default is 0", false, 0);
    ...
    cerr << "fastp2 v" << RABBITQC_VER << ", time used: " << (t2)-t1 << " seconds" << endl;
